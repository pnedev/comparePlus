...
#define IDC_THRESHOLD_SPIN_BOX			1030
#define IDC_THRESHOLD_SPIN_CTL			1031
#define IDC_COMBO_CHANGED_COLOR			1032
#define IDC_COMBO_ADD_HIGHLIGHT_COLOR	1033
#define IDC_COMBO_REM_HIGHLIGHT_COLOR	1034

...
inline void updateDlgCtrlTxt(HDC hdc, HWND hDlgWnd, int ctrlId, const std::wstring& txt)
{
	...
	::SetWindowPos(::GetDlgItem(hDlgWnd, ctrlId), nullptr, 0, 0, sz.cx, sz.cy, SWP_NOMOVE | SWP_NOZORDER);
}
